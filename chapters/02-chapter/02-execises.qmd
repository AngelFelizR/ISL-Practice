...
The data has **`r nrow(Boston)`** rows where each one represent a suburb of Boston and **`r ncol(Boston)`** columns where each one represent a summary indicator of each suburb. 
