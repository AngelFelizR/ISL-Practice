...
This model assumes that $f_{k}$ follow a **Normal (Gaussian) distribution** within each class.
...
In this functions it's clear that a class has more possibilities to be selected as mean for that particular class increases and its variance decreases.
