...
It models the **probability** ($p(X) = Pr(Y=1|X)$) that Y belongs to a particular category given some predictors. This model calculates the probability using the ***logistic function*** which produce a S form between 0 and 1:
